...
let words = plagiatsresolution.split(/ |\n/)
let counts = words
    .filter(word => !stopwords.includes(word) && word.trim().length > 0)
...
let mostCommon = Object.entries(counts)
    .sort(([_w, countA], [_w2, countB]) => countB - countA)
    .slice(0, 3)
    .map(([word, _]) => word)


console.log(mostCommon)
// ['akademischen', 'ethos', 'hochschule']